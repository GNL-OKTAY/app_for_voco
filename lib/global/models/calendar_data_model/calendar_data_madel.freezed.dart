...
class _$CalendarDataModelImpl implements _CalendarDataModel {
  ...
  factory _$CalendarDataModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$CalendarDataModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CalendarDataModel(endTime: $endTime, marketId: $marketId, notes: $notes, startTime: $startTime, subject: $subject, userId: $userId)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, endTime, marketId, notes, startTime, subject, userId);
  ...
  Map<String, dynamic> toJson() {
    return _$$CalendarDataModelImplToJson(
      this,
    );
  }
}
...
abstract class _CalendarDataModel implements CalendarDataModel {
  const factory _CalendarDataModel(
      ...
      final String? startTime,
      final String? subject,
      final String? userId}) = _$CalendarDataModelImpl;

  factory _CalendarDataModel.fromJson(Map<String, dynamic> json) =
      _$CalendarDataModelImpl.fromJson;
